...
export default function GeneralHeader(props:IProps) {
    ...
    const modeIcon = props.darkMode? <i className="fa fa-moon-o" style={{fontSize : '32px'}}/>  :  <i className="fa fa-sun-o" style={{fontSize : '32px'}}/> 
            ...
            <header className={Styles.mainHeader}>
                <div className={Styles.headerContainer}>
                    ...
                    <div className={Styles.headerButtons}>
                        ...
                        <HeaderButton onClickFunction={() => props.setDarkMode(!props.darkMode)}>
                            {modeIcon}
                        </HeaderButton>
                    </div>
                </div>
